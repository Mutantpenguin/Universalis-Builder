...
namespace Universalis
{
    public static class GroupPDFExporter
    {
        ...
        #region fonts
        private static readonly BaseFont s_baseFontUniversalis = BaseFont.CreateFont( UniversalisFont.FileName, BaseFont.CP1252, BaseFont.EMBEDDED, BaseFont.CACHED, Properties.Resources.NovaFlat_Regular, null );
